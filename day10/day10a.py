...
For example, consider this larger program: (condensed for space L->R)
...
arr = [int(i) if i.lstrip("-").isdigit() else 0 for cmd in cmds for i in cmd.split()]

total = [(1+sum(arr[:cycle]))*(cycle+1) for cycle in range(19,220,40)]

print(sum(total))

#Sum of Signal Strengths : 14340
